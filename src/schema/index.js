...
const { departments, departmentName, departmentPrivilege } = require("./department");
const { permissions } = require("./permissions");
const { passwordHistory } = require("./passwordHistory");

// Import Drizzle types for foreign key relationships
const { pgTable, text, foreignKey, primaryKey, integer, boolean, timestamp } = require("drizzle-orm/pg-core");

// Recreate tables with foreign key relationships
const doctorsWithFK = pgTable("doctors", {
...
const adminsWithFK = pgTable("admins", {
  id: text().primaryKey().notNull(),
